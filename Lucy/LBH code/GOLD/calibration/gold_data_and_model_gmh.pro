...
pro GOLD_data_and_model_GMH
  ...
  case user_name of
    ...
    'benjamincondit': begin
      path_lab_data = '/Users/benjamincondit/Desktop/IUVS_Breadboard/Round 10/data_reduction/'
      file_model = path_lab_data + 'Lucy' + path_sep() + 'LBH code' + path_sep() + 'calibration_victor' + path_sep() + 'n2_lbh_rot_293K.sav'
    end
    else: begin
