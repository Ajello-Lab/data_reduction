...
;   
;-
pro ajello_lab_contamination_check_n2_30ev
...
xr=[110,180]
p1 = plot( wave10, spec10, xtitle='wavelength', ytitle='DN/sec', yr=[0,1200], current=win, name='R10 - '+file_basename(file_r10), xr=xr, font_size=16 )
...
;win.save, path_save + 'N2_30eV_R10_vs_R12.png'

win = window(dim=[1600,800])
xr=[110,180]
p1 = plot( wave10, spec10/2, xtitle='wavelength', ytitle='DN/sec', yr=[0,800], current=win, name='R10 DIV 2 - '+file_basename(file_r10), xr=xr, font_size=16 )
p2 = plot( wave12, spec12, /over, color='red', name='R12 - '+file_basename(file_r12) )
p3 = plot( wave12b, spec12b/2, /over, color='blue', name='R12 DIV 2 - '+file_basename(file_r12b) )
leg = legend(target=[p1,p2,p3], font_size=16)
