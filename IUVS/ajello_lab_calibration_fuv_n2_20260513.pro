...
pro ajello_lab_calibration_fuv_n2_20260513
  ...
  files_to_read = strarr(20)
  files_to_read[0] = 'N2_30EV_FUV_TEST15_IMAGE1'
  files_to_read[1] = 'N2_100EV_FUV_TEST14_IMAGE2'
  files_to_read[2] = 'N2_30EV_FUV_TEST16_IMAGE3'
  files_to_read[3] = 'N2_16EV_FUV_TEST19_IMAGE2'
  files_to_read[4] = 'N2_16EV_FUV_TEST20_IMAGE3'
  files_to_read[5] = 'N2_20EV_FUV_TEST7_IMAGE1'
  files_to_read[6] = 'N2_20EV_FUV_TEST8_IMAGE2'
  files_to_read[7] = 'N2_20EV_FUV_TEST9_IMAGE3'
  files_to_read[8] = 'N2_20EV_FUV_TEST21_IMAGE1'
  files_to_read[9] = 'N2_30EV_FUV_TEST4_IMAGE1'
  files_to_read[10] = 'N2_30EV_FUV_TEST5_IMAGE2'
  files_to_read[11] = 'N2_30EV_FUV_TEST6_IMAGE3'
  files_to_read[12] = 'N2_12EV_FUV_TEST22_IMAGE1'
  files_to_read[13] = 'N2_16EV_FUV_TEST18_IMAGE1'
  files_to_read[14] = 'N2_30EV_FUV_TEST17_IMAGE2'
  files_to_read[15] = 'N2_100EV_FUV_TEST1_IMAGE1'
  files_to_read[16] = 'N2_100EV_FUV_TEST2_IMAGE2'
  files_to_read[17] = 'N2_100EV_FUV_TEST3_IMAGE3'
  files_to_read[18] = 'N2_100EV_FUV_TEST11_IMAGE3'
  files_to_read[19] = 'N2_100EV_FUV_TEST12_IMAGE1'
  ; ROUND 10
  ; files_to_read = strarr(24)
  ; files_to_read[0] = 'N2_16EV_FUV_TEST17_IMAGE1_HIPRESS'
  ; files_to_read[1] = 'N2_16EV_FUV_TEST18_IMAGE2_HIPRESS'
  ; files_to_read[2] = 'N2_16EV_FUV_TEST19_IMAGE3_HIPRESS'
  ; files_to_read[3] = 'N2_16EV_MUV_TEST17_IMAGE1_HIPRESS'
  ; files_to_read[4] = 'N2_16EV_MUV_TEST18_IMAGE2_HIPRESS'
  ; files_to_read[5] = 'N2_16EV_MUV_TEST19_IMAGE3_HIPRESS'
  ; files_to_read[6] = 'N2_20EV_FUV_TEST13_IMAGE1_HIPRESS'
  ; files_to_read[7] = 'N2_20EV_FUV_TEST14_IMAGE2_HIPRESS'
  ; files_to_read[8] = 'N2_20EV_FUV_TEST15_IMAGE3_HIPRESS'
  ; files_to_read[9] = 'N2_20EV_MUV_TEST13_IMAGE1_HIPRESS'
  ; files_to_read[10] = 'N2_20EV_MUV_TEST14_IMAGE2_HIPRESS'
  ; files_to_read[11] = 'N2_20EV_MUV_TEST15_IMAGE3_HIPRESS'
  ; files_to_read[12] = 'N2_30EV_FUV_TEST9_IMAGE1_HIPRESS_WITHH20'
  ; files_to_read[13] = 'N2_30EV_FUV_TEST10_IMAGE2_HIPRESS_WITHH20'
  ; files_to_read[14] = 'N2_30EV_FUV_TEST11_IMAGE3_HIPRESS_WITHH20'
  ; files_to_read[15] = 'N2_100EV_FUV_TEST6_IMAGE1_HIPRESS_WITHH20'
  ; files_to_read[16] = 'N2_100EV_FUV_TEST7_IMAGE2_HIPRESS_WITHH20'
  ; files_to_read[17] = 'N2_100EV_FUV_TEST8_IMAGE3_HIPRESS_WITHH20'
  ; files_to_read[18] = 'N2_100EV_FUV_TEST20_IMAGE1_HIPRESS'
  ; files_to_read[19] = 'N2_100EV_FUV_TEST21_IMAGE2_HIPRESS'
  ; files_to_read[20] = 'N2_100EV_FUV_TEST22_IMAGE3_HIPRESS'
  ; files_to_read[21] = 'N2_100EV_MUV_TEST20_IMAGE1_HIPRESS'
  ; files_to_read[22] = 'N2_100EV_MUV_TEST21_IMAGE2_HIPRESS'
  ; files_to_read[23] = 'N2_100EV_MUV_TEST22_IMAGE3_HIPRESS'
  ...
  ; files_to_read[31] = 'N2_50EV_FUV_TEST35_50EV_ROT+7_IMAGE3_HI_PRESS_4E-5'
  ; files_to_read[32] = 'N2_50EV_FUV_TEST36_50EV_ROT+7_IMAGE2_HI_PRESS_4E-5'
  ; files_to_read[33] = 'N2_50EV_MUV_TEST34_50EV_ROT_+7_IMAGE1_HI_PRESS_4E-5'
  ; files_to_read[34] = 'N2_50EV_MUV_TEST35_50EV_ROT+7_IMAGE3_HI_PRESS_4E-5'
  ; files_to_read[35] = 'N2_50EV_MUV_TEST36_50EV_ROT+7_IMAGE2_HI_PRESS_4E-5'
  ...
  for j = 0, n_elements(files_to_read) - 1 do begin
    ...
    ; amount_to_block = 1.2
    ; spec_subset = spec
    ; spec_subset[where(wlfuv lt 128 and wlfuv gt 200)] = 0.0 ; Lower bound for peaks to be found
    ; tallest_peak = where(spec_subset eq max(spec_subset))
    ; if tallest_peak lt 130 then begin
    ; blocked_first_peak = where(tallest_peak)
    ; spec_subset[where(wlfuv gt (wlfuv[blocked_first_peak] - amount_to_block) and wlfuv lt (wlfuv[blocked_first_peak] + amount_to_block))] = 0.0
    ; endif
    ; index = lonarr(3)
    ; for k = 0, 2 do begin
    ; index[k] = (where(spec_subset eq max(spec_subset)))[0]
    ; peak_wl = wlfuv[index[k]]
    ; zero_window = where(abs(wlfuv - peak_wl) lt amount_to_block, count) ; Width of X nm around the peak is blocked out for finding the next peak
    ...
    wl_spec = wlfuv - wlfuv[findndx(spec, max(spec))] + 135.4 ; where(ref eq max(ref))
    ;
