...
;
; PURPOSE:
;  Evaluate the 2-parameter Henyey-Greenstein phase function (alternate).
;
; DESCRIPTION:
;    different normilzation from fn_hg2
;
; CATEGORY:
;  Mathematical
;
...
;  2023/08/01 Created by Marc Buie (based on fn_HG2.pro)
;-
pro fn_hg2a,g,a,F,radians=radians
    ...
    F = (1.0+a[1])/2.0*fwd + (1.0-a[1])/2.0*bkwd
