   ...
   ; Input is decimal, must convert to sexigesimal
      ...
      case places of
         ...
         -6 : begin  ; XX:(00,30), Nearest 30 minutes.
            field1 = round((field1+field2/60.0d0)/30.0d0, /l64) * 30.0d0
         ...
         -5 : begin  ; XX:(00,15,30,45), Nearest 15 minutes.
            field1 = round((field1+field2/60.0d0)/15.0d0, /l64) * 15.0d0
            cvtsixty_adjust0,field0,field1,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)
         end
         ...
         -4 : begin  ; XX:M0, Nearest 10 minutes.
            field1 = round((field1+field2/60.0d0)/10.0d0, /l64) * 10.0d0
            cvtsixty_adjust0,field0,field1,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)
         end
         ...
         -3 : begin  ; XX:M(0,5), Nearest 5 minutes.
            field1 = round((field1+field2/60.0d0)/5.0d0, /l64) * 5.0d0
            cvtsixty_adjust0,field0,field1,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)
         end
         ...
         -2 : begin  ; XX:MM, Nearest minute.
            field1 = round(field1+field2/60.0d0, /l64)
            cvtsixty_adjust0,field0,field1,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)
         end
         ...
         -1 : begin  ; XX:MM:S0, Nearest 10 seconds.
            field2 = round(field2/10.0d0, /l64) * 10.0d0
         ...
         1 : begin   ; XX:MM:SS.s, Nearest tenth of a second.
            ...
            field2 = round(field2/0.1d0,/l64)*0.1d0
         ...
         2 : begin   ; XX:MM:SS.ss, Nearest hundredth of a second.
            field2 = round(field2/0.01d0,/l64)*0.01d0
            ; Save the fractional part of the seconds.
            fss = field2-long(field2)
            cvtsixty_adjust1,field0,field1,field2,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
         ...
         3 : begin   ; XX:MM:SS.sss, Nearest thousandth of a second.
            field2 = round(field2/0.001d0,/l64)*0.001d0
            ; Save the fractional part of the seconds.
            fss = field2-long(field2)
            cvtsixty_adjust1,field0,field1,field2,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
         ...
         4 : begin   ; XX:MM:SS.ssss, Nearest ten thousandth of a second.
            field2 = round(field2/0.0001d0,/l64)*0.0001d0
            ; Save the fractional part of the seconds.
            fss = field2-long(field2)
            cvtsixty_adjust1,field0,field1,field2,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
         ...
         5 : begin   ; XX:MM:SS.sssss, Nearest ten thousandth of a second.
            field2 = round(field2/0.00001d0,/l64)*0.00001d0
            ; Save the fractional part of the seconds.
            fss = field2-long(field2)
            cvtsixty_adjust1,field0,field1,field2,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)+ $
                     sepchar+string(field2,format=fmt1)+ $
                     strmid(string(fss,format='(F7.5)'),1,6)
         end

         6 : begin   ; XX:MM:SS.ssssss, Nearest hundred thousandth of a second.
            field2 = round(field2/0.000001d0,/l64)*0.000001d0
            ; Save the fractional part of the seconds.
            fss = field2-long(field2)
            cvtsixty_adjust1,field0,field1,field2,carry,maxval,wrap
            output = sign+string(field0,format=fmt0)+ $
                     sepchar+string(field1,format=fmt1)+ $
                     sepchar+string(field2,format=fmt1)+ $
                     strmid(string(fss,format='(F8.6)'),1,7)
         end

         else : begin
            print,self,'PLACES parameter must be in the range -8 to +5.'
            return
         end
      end
