...
;         The mean of the image is subtracted in this case but it's not
...
;     MASK   - Optional image mask for pixels to ignore.  Good pixels=0,
;                bad pixels=1.  The size of this image must match the input
;                image.
