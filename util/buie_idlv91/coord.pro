...
;                  Also accepts a structure with the observatory information
;                  tags: obs: 'G**', lat, lon, alt, name
...
;     2022/08/09, MWB, added support for non-standard observatory locations
;     2024/07/06, MWB, reworked for new obs structure support
;-
pro coord,jd,in_obs,object,namefile,ra,dec, $
   ...
   if badpar(in_obs,[2,3,7,8],[0,1],caller='COORD: (obs) ',type=codetype) then return
   ...
   type = strupcase(strmid(standard,0,1))
