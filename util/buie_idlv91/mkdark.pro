...
;-
pro mkdark,root,outsuf,start,nframes,bias,dark,good,DDIR=ddir, $
...
print,'Stack average ',strn(nf),' images.'
            avgclip,tmpcube,dark,noisemin=rdnoise/exptime,success=success
            if success then $
               gradedark,cube,dark,grade,maxbad=maxbad,filetest=filetest $
            else $
               grade=nf
print,filetest
