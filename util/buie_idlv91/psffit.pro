...
;             default=1.0
;  MAXPHOTSIG - maximum signal level to use in fit, default=60000
...
;  2017/06/08, MWB, allow scalar input on xin,yin
;  2024/01/26, MWB, added MAXPHOTSIG keyword
;-
...
pro psffit,image,psf,region,xin,yin,xout,yout,counts, $
       ...
       FWHM=fwhm,PSF_FWHM=fwhmpsf,MAXPHOTSIG=maxphotsig
...
; added saturation check
      zm=where(cmask eq 1 and image[x0:x1,y0:y1] lt maxphotsig,countm)
