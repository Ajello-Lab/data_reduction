...
;    ZPOINT  - Optional zero point.  This value does not affect the returned
;                 magnitudes, only the magnitude printed in the chatty output
...
pro basphote, gain, image, exptime, xloc, yloc, radius, sky1, sky2, $
   ...
   ;      if timeit then cputime,time7
         ...
         ;varphotobj = photons + sigphotsky * sigphotsky   OLD
         varphotobj = photons + area*skyphot 
