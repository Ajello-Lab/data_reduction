...
;  instruments 
   ...
   mntpts_PCCD=['/net/mandor/raid']
;   mntpts_Nasacam =  ['/media/usbdisk']
   mntpts_Nasacam =  ['/net/coral/raid','/net/mandor/raid']
   mntpts_site2k =  ['/net/mandor/raid']
...
; ------------------------------------------------------------------------------
         ...
         'tr': begin
            ...
            transf,pdata.stand[zfil],pdata.jd[zfil], $
               ...
               DVERBOSE=dverbose,amsq=x2,colsq=c2,refcolor=op.rc,refam=op.rx
