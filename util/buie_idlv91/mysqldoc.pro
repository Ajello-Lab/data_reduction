...
pro mysqldoc,in_lun,table,outfile,DBNAME=dbname,OUTDIR=outdir
   ...
   if table eq '' then begin
      ...
      printf,olun,'<html>'
      printf,olun,'<head>'
      printf,olun,'<title>',dbname,' database documentation index</title>'
      printf,olun,'</head>'
      printf,olun,'<body>'
      printf,olun,'<h1><em>',dbname,'</em> database documentation index</h1>'
      ...
      printf,olun,'<head>'
      if dbname ne '' then $
         printf,olun,'<title>',dbname,'.',table,' table documentation</title>' $
      else $
         printf,olun,'<title>',table,' table documentation</title>'
      printf,olun,'</head>'
      printf,olun,'<body>'
      if dbname ne '' then $
         printf,olun,'<h1><em>',dbname,'.',table,'</em> table documentation</h1>' $
      else $
         printf,olun,'<h1><em>',table,'</em> table documentation</h1>'
